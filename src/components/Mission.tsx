        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center">
            <div className="bg-fosshid-yellow rounded-full p-6 w-24 h-24 mx-auto mb-6 flex items-center justify-center">
              <Heart className="h-12 w-12 text-foreground" />
            </div>
            <h3 className="text-xl font-bold text-foreground mb-4">Amour</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-foreground mb-4">Unité</h3>
            <p className="text-muted-foreground">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-foreground mb-4">Développement</h3>
            <p className="text-muted-foreground">
