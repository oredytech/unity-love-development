...
const Hero = () => {
  return (
    <div className="relative bg-fosshid-blue min-h-screen flex items-center">
      <div className="absolute inset-0 bg-gradient-to-r from-fosshid-blue/90 to-fosshid-green/40"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <Link
                to="/join"
                className="bg-fosshid-green hover:bg-green-100 text-gray-800 font-bold py-3 px-8 rounded-lg transition duration-300"
              >
                Nous Rejoindre
              </Link>
              <Link
